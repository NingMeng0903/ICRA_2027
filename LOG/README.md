...
Z reuses `DATA/03_chirp/chirp.csv`. Scripts 07, 08, and 11–14 have not been
collected. Contact ID copies Window A into `DATA/<kind>/window_a.csv` instead
of growing this folder. Do not copy the rest of
`rm75_control/apps/logs/peirastic/` (gigabytes, other campaigns).
